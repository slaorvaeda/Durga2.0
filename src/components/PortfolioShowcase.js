      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="relative flex items-center gap-6 pb-6">
          ...
          {visibleCards.map((card, i) => (
            <div key={card.title} className="min-w-[320px]  bg-gray-100 rounded-2xl shadow-lg p-4 relative cursor-pointer" onClick={() => setOpenCard(card)}>
              <img src={card.image} alt={card.title} className="rounded-xl w-full mb-2" />
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
            <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full p-8 relative animate-fadein flex flex-col md:flex-row gap-6">
              ...
              <div className="flex-shrink-0 flex justify-center items-center md:w-1/2 w-full">
                <img src={openCard.image} alt={openCard.title} className="rounded-xl w-full max-w-xs mb-4 md:mb-0" />
              </div>
